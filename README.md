...
## Customize
- Eth mainnet is target as default network. You can easily add the `--ropsten` or `--rinkeby` flags in the `node-statefulset.yaml` file to sync a node for test networks.
